...
public:
    ...
    public:
        ...
        bool valid_move(int from_x, int from_y, int to_x, int to_y) const override{
            if(abs(to_x - from_x) <= 1 && abs(to_y - from_y) <= 1){
                if(abs((to_x - from_x) + (to_y - from_y)) != 0){
                    return true;
                } 
            }
            return false;
        ...
        std::string type() const override {
            std::string type = Piece::color_string() + " king";
            return type;
        }
  ...
  class Knight : public Piece {
    public:
        ...
        bool valid_move(int from_x, int from_y, int to_x, int to_y) const override{
            if(abs((to_x - from_x) * (to_y - from_y)) == 2) {
                return true;
            }
            return false;
        }
        ...
        std::string type() const override {
            std::string type = Piece::color_string() + " knight";
            return type;
        }
